...
import {PostBoardBody, PatchBoardBody, PatchListOrderingBody, BoardsModel} from "../models/boards";
...
class BoardService {
    ...
    async getBoardById(board_id: string, req: any) {
        ...
        const board: BoardsModel | undefined = await getRepository(Board).createQueryBuilder("board")
